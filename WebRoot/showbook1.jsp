...
<script type="text/javascript">
	...
	function itembuy(n){
		...
		document.getElementById("buynum"+n).value = buynum;
		location.href = "cartProcess.jsp?action=buy&goodstype=clothes&id="+n+"&buynum="+buynum;
	}
</script>
</head>
<body background="img/background.jpg">
	<center>
		<%
		    ...
		    List list=goodsdao.findtype("哲学");
		    session.setAttribute("clotheslist",list);
		%>
		<!-- 用表格来设计主界面 -->
					...
					<table border="1" width=100% class="one" bgcolor=#FFFF99>
						...
						<%
								...
								for (int i = 0; i < clotheslist.size(); i++) {
									Goods single = (Goods) clotheslist.get(i);
									int index = i;
						%>
